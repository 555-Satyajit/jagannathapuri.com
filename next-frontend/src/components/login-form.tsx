    ...
    try {
      ...
      if (result.success || response.ok) {
        setUser({
          ...
          fullName: result.user ? result.user.fullName : email.split('@')[0],
        });
      ...
      <FieldGroup>
        ...
        <Field>
          ...
          <FieldDescription className="text-center">
            ...
            <a href={`/signup${searchParams.toString() ? `?${searchParams.toString()}` : ''}`} className="underline underline-offset-4">
              Sign up
            </a>
          </FieldDescription>
        </Field>
