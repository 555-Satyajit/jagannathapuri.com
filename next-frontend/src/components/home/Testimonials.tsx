  ...
  const testimonials = [
    {
      ...
      quote: "The authenticity of the Mahaprasad from Jay Subhdra is truly divine. It arrived perfectly packed and brought the blessings of Lord Jagannath directly to our home.",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Finding pure and authentic Puja samagri online used to be difficult until I found Jay Subhdra. Their fast delivery and beautiful packaging make every festival special.",
      rating: 5,
